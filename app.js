...
// Once you get the test passing, do an a-c-p cycle, synchronize the code
//between both GitHubs and both laptops, and swap Driver/Navigator roles.
...
arguments and returns an array where the first element is the sum of those three
 ...
 third and fourth elements are strings that EXACTLY follow this example and
...
// Once you get the test passing, do an a-c-p cycle, synchronize the code
//between both GitHubs and both laptops, and swap Driver/Navigator roles. don't
...
argument and then returns an array where the first element is the sum of the
numbers in the array, and the second element is a string that EXACTLY follows
...
// Once you get the test passing, do an a-c-p cycle, synchronize the code
//between both GitHubs and both laptops, and swap Driver/Navigator roles. Don't forget to create a new branch for your work on the next question!
...
// Once you get the test passing, do an a-c-p cycle, synchronize the code
//between both GitHubs and both laptops, and swap Driver/Navigator roles.
//Submit the link to the repo via Canvas.
